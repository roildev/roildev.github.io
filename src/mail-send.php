...
$mail->Body    = $season . ' хотят заказать трансфер - <b>' . $quantity . ' человек </b>' . '<br>' . $wait . ' их будет ждать примерно ' . $wait_time . '<br> Им нужно будет проехать примерно: <b>' . $distance . 'км. </b>' . '<br> У них ' . $childs_availible . '<br> Калькулятор на сайте насчитал - <b>' . $price_total . '</b> <br><br> Город прилета: ' . $city_from . '<br> Место назначения: ' . $city_to . '<br> Телефон: ' . $customer_phone . '<br> Имя: ' . $customer_name;


$mail->AltBody = $season . ' хотят заказать трансфер - ' . $quantity . ' человек' .  $wait . ' их будет ждать' . $wait_time . 'Им нужно будет проехать примерно: ' . $distance . 'км. ' . 'У них ' . $childs_availible . 'Калькулятор на сайте насчитал - ' . $price_total . ' Город прилета: ' . $city_from . ' Место назначения: ' . $city_to . ' Телефон: ' . $customer_phone . ' Имя: ' . $customer_name;
